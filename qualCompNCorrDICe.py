...
# # === Create grids ===
# X_zn, Y_zn, Z_znssd = make_grid(znssd_df["x"], znssd_df["y"], znssd_df["znssd"])
# X_nc, Y_nc, Z_ncc   = make_grid(ncc_df["x"], ncc_df["y"], ncc_df["ncc"])

# # === Plot side by side ===
# fig, axs = plt.subplots(1, 2, figsize=(12,5))

# im1 = axs[0].pcolormesh(X_zn, Y_zn, Z_znssd, shading="auto", cmap="viridis")
# axs[0].set_title("NCorr ZNSSD")
# axs[0].set_aspect("equal"); axs[0].invert_yaxis()
# fig.colorbar(im1, ax=axs[0])

# im2 = axs[1].pcolormesh(X_nc, Y_nc, Z_ncc, shading="auto", cmap="viridis")
# axs[1].set_title("NCorr NCC")
# axs[1].set_aspect("equal"); axs[1].invert_yaxis()
